...
public class C01_Substring {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Lütfen ad ve soyadınızı aralarında boşluk olarak giriniz");
        ...
        String modifiedFirstName = firstName.substring(0, 1).toUpperCase()
                + firstName.substring(1).toLowerCase();
        String modifiedLastName = lastName.substring(0, 1).toUpperCase()
                + lastName.substring(1).toLowerCase();

        System.out.println("modifiedFirstName = " + modifiedFirstName);
        System.out.println("modifiedLastName = " + modifiedLastName);
